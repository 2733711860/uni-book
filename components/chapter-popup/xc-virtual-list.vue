<template>
	<scroll-view scroll-y="true" :style="{ 'height': '100%', 'position': 'relative' }" @scroll="handleScroll">
		<view class="scroll-bar" :style="{ 'height': localHeight + 'px' }"></view>
		<view class="list" :style="{ 'transform': `translateY(${offset}px)` }">
