...
<script>
	...
	import readViewOne from '@/components/read/read-view-one.vue'
	export default {
		components: {
			readTool, readViewOne
		},
		...
		methods: {
			getTheme() { // 设置主题
				...
				this.textColor = zhuti.data[this.themeIndex].textColor; // 富文本文字颜色
			},
